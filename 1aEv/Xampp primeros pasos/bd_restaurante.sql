...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-10-2023 a las 11:44:07
...
CREATE TABLE `platos_ingredientes` (
  `pl_id` int(11) NOT NULL,
  `ing_id` int(11) NOT NULL,
  `pling_cantidad` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
ALTER TABLE `platos`
  ...
  ADD CONSTRAINT `r-platos-platos_ingredientes` FOREIGN KEY (`pl_id`) REFERENCES `platos_ingredientes` (`pl_id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Filtros para la tabla `platos_ingredientes`
--
ALTER TABLE `platos_ingredientes`
  ADD CONSTRAINT `r-ingredientes-platos_ingredientes` FOREIGN KEY (`ing_id`) REFERENCES `ingredientes` (`ing_id`) ON DELETE NO ACTION ON UPDATE CASCADE;
COMMIT;
