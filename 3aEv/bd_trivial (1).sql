...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-04-2024 a las 10:31:16
...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `insertar_categorias` (IN `_categoria` VARCHAR(50), IN `_color` VARCHAR(50))  NO SQL
INSERT INTO categorias VALUES
(null, _categoria,_color)$$
...
(6, 'Espectáculos', 'Rosa'),
(7, 'Películas', 'Rojo'),
(8, 'Programacion', 'Blanco'),
(9, 'BBDD', 'AMARILLO PRUEBA');
